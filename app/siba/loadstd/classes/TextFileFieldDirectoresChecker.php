 ...
 */
class TextFileFieldDirectoresChecker implements \Siba\loadstd\interfaces\FileDataFieldChecker {
    //put your code here
    private $return;
    ...
    public function checkFieldIntegrity($field) {
            ...
            foreach ($arrRecords as $record){
                ...
                if (preg_match("/\|/",$record)) {
                    ...
                    if (count($arrRecord)<3){
                        ...
                        $this->return->value = 0;
                        $this->return->notes = "Se ha definido mal un campo de directores: ".$field;
                        return $this->return;
        ...
        if (preg_match("/[a-zA-Z0-9\ \'\"]{3,120}/",$field)){
            ...
            $this->return->status = false;
            $this->return->value = 0;
            $this->return->notes = "Existe un error en el campo directores".": ".$field;
            return $this->return;
